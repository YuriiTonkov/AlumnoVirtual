function Controller() {
    ...
    $.__views.GrupoTab.addTab($.__views.__alloyId36.getViewEx({
        recurse: true
    }));
    $.__views.__alloyId38 = Alloy.createController("TabCalendario", {
        id: "__alloyId38"
    });
    $.__views.GrupoTab.addTab($.__views.__alloyId38.getViewEx({
        recurse: true
    }));
    $.__views.__alloyId40 = Alloy.createController("TabConfiguracion", {
        id: "__alloyId40"
    });
    $.__views.GrupoTab.addTab($.__views.__alloyId40.getViewEx({
        recurse: true
    }));
